...
\begin{figure}[H]
    \centering
    \resizebox{0.7\textwidth}{!}{\input{lab7p1_counter_struct.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{0.7\textwidth}{!}{\input{lab7p1_top_level.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{0.7\textwidth}{!}{\input{numeric_std_conversions.tex}}
