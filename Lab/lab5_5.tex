...
\begin{itemize}
    ...
    \end{itemize}
    \item Resistors: $330\Omega$ (for LEDs and pull-down)
    \item DIP switches
    \item LEDs (Red/Green)
\end{itemize}
...
\begin{itemize}
    ...
    \item Use $330\Omega$ pull-down resistors to ensure logic '0' when OFF (Open).
...
\begin{figure}[H]
    ...
    \begin{circuitikz}
        ...
        to[R, l_=$330\Omega$] (0,-2) node[ground] (gnd) {};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../public/lab5_5.png}
